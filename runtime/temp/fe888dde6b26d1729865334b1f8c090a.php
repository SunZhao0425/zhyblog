<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"E:\phpStudy\PHPTutorial\WWW\zhyblog\public/../application/admin\view\user\user_add.html";i:1541597899;s:70:"E:\phpStudy\PHPTutorial\WWW\zhyblog\application\admin\view\layout.html";i:1541686533;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="/admin/Login/outlogin" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
...
<div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
            ...
            <li><a href="/admin/Notice/index">公告</a></li>
            <li><a href="/admin/Comment/index">评论</a></li>
            <li><a data-toggle="tooltip" data-placement="bottom" title="网站暂无留言功能">留言</a></li>
        </ul>
        <ul class="nav nav-sidebar">
            <li><a href="/admin/Category/index">栏目</a></li>
            <li><a class="dropdown-toggle" id="otherMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">其他</a>
                <ul class="dropdown-menu" aria-labelledby="otherMenu">
                    <li><a href="/admin/Flink/index">友情链接</a></li>
        ...
        <ul class="nav nav-sidebar">
            <li><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">用户</a>
                <ul class="dropdown-menu" aria-labelledby="userMenu">
                    ...
                    <li><a href="/admin/User/add">管理用户</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a href="/admin/User/index">管理登录日志</a></li>
                </ul>
            </li>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
    <div class="modal-dialog" role="document" style="max-width:450px;">
        <form action="/admin/User/add" method="post" autocomplete="off" draggable="false" class="zform">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary subUser">提交</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="modal fade" id="seeUser" tabindex="-1" role="dialog" aria-labelledby="seeUserModalLabel">
    <div class="modal-dialog" role="document" style="max-width:450px;">
        <form action="/admin/User/update" method="post" autocomplete="off" draggable="false">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script>
    var dain = JSON.parse('<?php echo $data; ?>');
</script>
<script  src="/static/layer/layer.js"></script>
<script src="/static/admin/js/user-add.js"></script>
